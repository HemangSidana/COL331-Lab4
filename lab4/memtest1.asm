...
00000010 <mem>:
{
  ...
  5c:	e8 4f 06 00 00       	call   6b0 <malloc>
		if (m2 == 0)
  ...
  85:	eb 15                	jmp    9c <mem+0x8c>
  87:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  8e:	66 90                	xchg   %ax,%ax
		count++;
  90:	83 c0 01             	add    $0x1,%eax
		m1 = *(char**)m1;
  93:	8b 1b                	mov    (%ebx),%ebx
	while (count != total_count) {
  95:	3d 60 02 00 00       	cmp    $0x260,%eax
  9a:	74 07                	je     a3 <mem+0x93>
		if (((int*)m1)[2] != count)
  9c:	3b 43 08             	cmp    0x8(%ebx),%eax
  9f:	74 ef                	je     90 <mem+0x80>
  a1:	eb c5                	jmp    68 <mem+0x58>
	int upt2 = uptime();
  a3:	e8 03 03 00 00       	call   3ab <uptime>
	int diff = upt2-upt1;
  a8:	2b 45 e4             	sub    -0x1c(%ebp),%eax
	printf(1, "MemTest1 Passed!\n", diff);
  ab:	52                   	push   %edx
  ac:	50                   	push   %eax
  ad:	68 a8 07 00 00       	push   $0x7a8
  b2:	6a 01                	push   $0x1
  b4:	e8 c7 03 00 00       	call   480 <printf>
	exit();
  b9:	e8 55 02 00 00       	call   313 <exit>
  be:	66 90                	xchg   %ax,%ax
 ...
 3dc:	89 d1                	mov    %edx,%ecx
{
 ...
 409:	0f b6 92 2c 08 00 00 	movzbl 0x82c(%edx),%edx
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4f9:	ff 24 85 d4 07 00 00 	jmp    *0x7d4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 607:	90                   	nop
          s = "(null)";
 608:	ba cc 07 00 00       	mov    $0x7cc,%edx
        while(*s != 0){
